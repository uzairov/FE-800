...
const TEMPLATES: TemplateSpec[] = [
  // 1. Sales Manager
  {
    ...
    competencies: [
      ...
      { key: 'self_motivation',           weight: 2 },
      { key: 'locus_of_control',          weight: 2 },
      { key: 'service_orientation',       weight: 2 },
      { key: 'proactivity',               weight: 2 },
      { key: 'adaptability',              weight: 2 },
      { key: 'time_management',           weight: 2 },
      { key: 'problem_solving',           weight: 2 },
      { key: 'analytical_thinking',       weight: 1 },
      { key: 'learning_agility',          weight: 1 },
      { key: 'responsibility',            weight: 1 },
      { key: 'conflict_management',       weight: 1 },
      { key: 'decision_making',           weight: 1 },
      { key: 'ethical_judgment',          weight: 1 },
  ...
  // 2. Call Center Operator
  {
    ...
    competencies: [
      ...
      { key: 'locus_of_control',          weight: 2 },
      { key: 'empathy',                   weight: 2 },
      { key: 'adaptability',              weight: 2 },
      { key: 'time_management',           weight: 2 },
      { key: 'responsibility',            weight: 1 },
      { key: 'learning_agility',          weight: 1 },
      { key: 'problem_solving',           weight: 1 },
      { key: 'teamwork',                  weight: 1 },
      { key: 'conflict_management',       weight: 1 },
      { key: 'ethical_judgment',          weight: 1 },
      { key: 'proactivity',               weight: 1 },
      { key: 'process_orientation',       weight: 1 },
    ],
  ...
  // 4. HR Specialist
  {
    ...
    competencies: [
      ...
      { key: 'communication_flexibility', weight: 3 },
      { key: 'attention_to_detail',       weight: 3 },
      { key: 'empathy',                   weight: 3 },
      { key: 'ethical_judgment',          weight: 3 },
      { key: 'service_orientation',       weight: 2 },
      { key: 'honesty',                   weight: 2 },
      { key: 'stress_resistance',         weight: 2 },
      { key: 'conflict_management',       weight: 2 },
      { key: 'analytical_thinking',       weight: 2 },
      { key: 'learning_agility',          weight: 2 },
      { key: 'time_management',           weight: 2 },
      { key: 'adaptability',              weight: 2 },
      { key: 'problem_solving',           weight: 2 },
  ...
  // 5. Accountant
  {
    ...
    competencies: [
      ...
      { key: 'monotolerance',             weight: 3 },
      { key: 'ethical_judgment',          weight: 3 },
      { key: 'responsibility',            weight: 3 },
      { key: 'systems_thinking',          weight: 2 },
      { key: 'attention',                 weight: 2 },
      { key: 'stress_resistance',         weight: 2 },
      { key: 'analytical_thinking',       weight: 2 },
      { key: 'time_management',           weight: 2 },
      { key: 'process_orientation',       weight: 2 },
      { key: 'learning_agility',          weight: 2 },
      { key: 'adaptability',              weight: 2 },
      { key: 'locus_of_control',          weight: 1 },
      { key: 'self_motivation',           weight: 1 },
      { key: 'problem_solving',           weight: 1 },
      { key: 'communication_flexibility', weight: 1 },
      { key: 'decision_making',           weight: 1 },
      { key: 'risk_assessment',           weight: 1 },
      { key: 'teamwork',                  weight: 1 },
      { key: 'proactivity',               weight: 1 },
    ],
  ...
  // 6. IT Developer
  {
    ...
    competencies: [
      ...
      { key: 'problem_solving',           weight: 3 },
      { key: 'attention_to_detail',       weight: 3 },
      { key: 'analytical_thinking',       weight: 3 },
      { key: 'learning_agility',          weight: 3 },
      { key: 'self_motivation',           weight: 2 },
      { key: 'attention',                 weight: 2 },
      ...
      { key: 'responsibility',            weight: 2 },
      { key: 'innovation',                weight: 2 },
  ...
  // 7. Customer Success Manager
  {
    ...
    competencies: [
      ...
      { key: 'locus_of_control',          weight: 1 },
      { key: 'ethical_judgment',          weight: 1 },
      { key: 'negotiation',               weight: 1 },
      { key: 'decision_making',           weight: 1 },
    ],
    blocks: ['CX_SJT', 'CX_PSS', 'CX_EQ', 'CX_CASE', 'CX_INTERVIEW'],
  },
  ...
  // 8. Logistics / Warehouse Manager
  {
    ...
    competencies: [
      ...
      { key: 'attention_to_detail',       weight: 3 },
      { key: 'stress_resistance',         weight: 3 },
      { key: 'process_orientation',       weight: 3 },
      { key: 'decision_making',           weight: 3 },
      { key: 'monotolerance',             weight: 2 },
      { key: 'result_orientation',        weight: 2 },
      { key: 'honesty',                   weight: 2 },
      ...
      { key: 'time_management',           weight: 2 },
      { key: 'problem_solving',           weight: 2 },
      { key: 'risk_assessment',           weight: 2 },
      { key: 'analytical_thinking',       weight: 2 },
      { key: 'adaptability',              weight: 1 },
      { key: 'learning_agility',          weight: 1 },
      { key: 'teamwork',                  weight: 1 },
      { key: 'responsibility',            weight: 1 },
      { key: 'communication_flexibility', weight: 1 },
  ...
  // 10. Executive / Director
  {
    ...
    competencies: [
      { key: 'leadership',                weight: 3 },
      { key: 'systems_thinking',          weight: 3 },
      { key: 'strategic_thinking',        weight: 3 },
      { key: 'decision_making',           weight: 3 },
      { key: 'result_orientation',        weight: 3 },
      { key: 'emotional_intelligence',    weight: 2 },
      { key: 'negotiation',               weight: 2 },
...
const PLANS = [
  ...
  },
  {
    ...
    hasAiAssistant: true,
    priceUsd: 150,
    features: ['Безлимит оценок', 'Безлимит пользователей', 'Белый лейбл'],
  },
];
